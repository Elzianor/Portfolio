#ifndef COMMON_PIXEL_SHADERS_FXH
#define COMMON_PIXEL_SHADERS_FXH

#include "CommonUniforms.fxh"
#include "CommonStructures.fxh"
#include "ColorCorrection.fxh"
#include "Light.fxh"
#include "PhysicallyBasedRendering.fxh"
#include "ParallaxOcclusionMapping.fxh"

float4 PS_PBR_Solid(VSOutputPBRSolid input) : SV_TARGET
{
    ...
    if (IsDoubleSidedMaterial) normal = GetDoubleSidedMaterialNormal(normal, viewDirection);
...
float4 PS_PBR_Textured(VSOutputPBRTextured input) : SV_TARGET
{
